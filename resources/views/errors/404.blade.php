...
<div class="wrap">
    <div>
        ...
        <p>La page, le produit ou l'entreprise que vous recherchez n'existe pas ou a été retiré.</p>
        <a href="/" class="btn">Retour à l'accueil</a>
        <a href="/galerie/produits" class="btn btn-sec">Explorer la galerie</a>
    </div>
</div>
</body>
</html>
