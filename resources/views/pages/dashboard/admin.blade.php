...
@section('content')
            ...
            <div class="mt-4 grid grid-cols-2 md:grid-cols-3 2xl:grid-cols-6 gap-3">
                ...
                <div class="bg-white dark:bg-[#12150F] border border-[#EFEBE2] dark:border-[#262B21] rounded-2xl p-3.5 flex flex-col">
            ...
            <div class="mt-4 flex flex-col 2xl:flex-row gap-4 items-start">
                <div class="flex-1 min-w-0 w-full">
                    ...
                    <div class="flex flex-col xl:flex-row gap-4 items-stretch">
                        <section class="flex-[1.05] min-w-0 bg-white dark:bg-[#12150F] border border-[#EFEBE2] dark:border-[#262B21] rounded-2xl p-5">
                            <div class="flex items-center justify-between gap-3">
                                <h2 class="text-[13px] font-bold tracking-[0.04em] text-[#1B1B18] dark:text-[#F3EFE7] uppercase">{{ $isFr ? 'Répartition des artisans par région' : 'Artisans by region' }}</h2>
                                <a href="{{ route('admin.regions') }}" class="shrink-0 text-[11.5px] font-semibold text-[#157A43] dark:text-[#339B56] hover:text-[#14532D] dark:hover:text-[#339B56] whitespace-nowrap">{{ $isFr ? 'Voir la carte détaillée' : 'Detailed map' }} →</a>
                            </div>
                            <div class="mt-3 flex flex-col sm:flex-row gap-4">
                                ...
                                <ul class="flex-1 min-w-0 space-y-[7px] self-center">
                                    ...
                                    <li class="flex items-center gap-2.5 text-[11px] text-[#3B382F] dark:text-[#B4B5A6] whitespace-nowrap">
                                    ...
                                    @empty
                                    <li class="text-[11px] text-[#8A857A] dark:text-[#868778]">{{ $isFr ? 'Aucune donnée régionale.' : 'No regional data.' }}</li>
                                    @endforelse
                                </ul>
                            </div>
                            <a href="{{ route('businesses.index', ['lang' => $lang]) }}" class="mt-3 inline-flex items-center gap-2 border border-[#CFE0D4] dark:border-[#39402F] hover:border-[#14652F] dark:hover:border-[#2E9250] rounded-lg px-4 py-2 text-[12px] font-semibold text-[#14652F] dark:text-[#339B56] transition-colors">
                                <i data-lucide="map-pin" class="w-3.5 h-3.5"></i>
                                {{ $isFr ? 'Explorer par région' : 'Explore by region' }}
                            </a>
                        </section>

                        <section class="flex-1 min-w-0 bg-white dark:bg-[#12150F] border border-[#EFEBE2] dark:border-[#262B21] rounded-2xl p-5">
                            <div class="flex items-center justify-between gap-3">
                                <h2 class="text-[13px] font-bold tracking-[0.04em] text-[#1B1B18] dark:text-[#F3EFE7] uppercase">{{ $isFr ? 'Évolution des visites' : 'Visits over time' }}</h2>
                                <span class="shrink-0 inline-flex items-center gap-1.5 border border-[#E9E4D8] dark:border-[#39402F] rounded-lg px-3 py-1.5 text-[11.5px] text-[#3B382F] dark:text-[#B4B5A6]">
                            ...
                            <div class="mt-4 grid grid-cols-2 gap-y-3">
                                ...
                                <div class="px-3 first:pl-0">
                                    <p class="text-[10px] font-bold tracking-[0.05em] text-[#8A857A] dark:text-[#868778] uppercase whitespace-nowrap">{{ $vsLabel }}</p>
                                    <p class="mt-1 text-[15.5px] font-bold text-[#1B1B18] dark:text-[#F3EFE7]">{{ $vsValue }}</p>
                                </div>
                                @endforeach
                            </div>
                        </section>
                    ...
                    <!-- Quick actions -->
                    <section class="mt-4">
                        <h2 class="text-[13px] font-bold tracking-[0.04em] text-[#1B1B18] dark:text-[#F3EFE7] uppercase">{{ $isFr ? 'Actions rapides' : 'Quick actions' }}</h2>
                        <div class="mt-3 grid grid-cols-2 sm:grid-cols-4 xl:grid-cols-8 gap-3">
                            @foreach($adActions as [$qaIcon, $qaColor, $qaLabel, $qaUrl])
                            <a href="{{ $qaUrl }}" class="bg-white dark:bg-[#12150F] border border-[#EFEBE2] dark:border-[#262B21] hover:border-[#14652F] dark:hover:border-[#2E9250] rounded-2xl px-3 py-4 text-center transition-colors">
                                <i data-lucide="{{ $qaIcon }}" class="w-[26px] h-[26px] mx-auto" style="stroke-width:1.5;color:{{ $qaColor }}"></i>
                                <p class="mt-2.5 text-[11.5px] font-semibold text-[#3B382F] dark:text-[#B4B5A6] leading-snug whitespace-pre-line">{{ $qaLabel }}</p>
                            </a>
                            @endforeach
                        </div>
                    </section>
                    ...
                    <div class="mt-4 grid grid-cols-1 xl:grid-cols-3 gap-4 items-stretch">
                        <section class="bg-white dark:bg-[#12150F] border border-[#EFEBE2] dark:border-[#262B21] rounded-2xl p-5">
                            <div class="flex items-center justify-between gap-3">
                                <h2 class="text-[12px] font-bold tracking-[0.04em] text-[#1B1B18] dark:text-[#F3EFE7] uppercase leading-snug">{{ $isFr ? 'Top 5 catégories de produits' : 'Top 5 product categories' }}</h2>
                                <a href="{{ route('admin.industries') }}" class="shrink-0 text-[11.5px] font-semibold text-[#157A43] dark:text-[#339B56]">{{ $isFr ? 'Voir tout' : 'See all' }}</a>
                            </div>
                            <div class="mt-4 space-y-3.5">
                                @forelse($adTopCatsView as [$tcRank, $tcLabel, $tcCount, $tcPct])
                                <div class="flex items-center gap-3">
                                    <span class="w-[22px] h-[22px] shrink-0 rounded-full bg-[#F1EADB] dark:bg-[#1A1E16] text-[#8A6D1F] dark:text-[#EDB33A] text-[11px] font-bold flex items-center justify-center">{{ $tcRank }}</span>
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center justify-between gap-3">
                                            <p class="text-[12px] font-bold text-[#1B1B18] dark:text-[#F3EFE7] whitespace-nowrap">{{ $tcLabel }}</p>
                                            <p class="shrink-0 text-[11px] text-[#55524A] dark:text-[#B4B5A6] whitespace-nowrap">{{ $tcCount }} {{ $isFr ? 'produits' : 'products' }}</p>
                                        </div>
                                        <div class="mt-1.5 h-[4px] rounded-full bg-[#EFEBE2] dark:bg-[#1A1E16]"><div class="h-full rounded-full bg-[#14652F] dark:bg-[#2E9250]" style="width:{{ $tcPct }}%"></div></div>
                                    </div>
                                </div>
                                @empty
                                <p class="text-[12px] text-[#8A857A] dark:text-[#868778]">{{ $isFr ? 'Aucune catégorie de produits pour le moment.' : 'No product categories yet.' }}</p>
                                @endforelse
                            </div>
                        </section>
                        ...
                        <section class="bg-white dark:bg-[#12150F] border border-[#EFEBE2] dark:border-[#262B21] rounded-2xl p-5">
                            ...
                            <div class="mt-4 flex items-center gap-4">
                                <div class="relative w-[110px] h-[110px] shrink-0 rounded-full" style="background:{{ $adKycCss }}">
                                    <div class="absolute inset-[16px] rounded-full bg-white dark:bg-[#12150F] flex flex-col items-center justify-center text-center">
                                        <span class="text-[9px] text-[#8A857A] dark:text-[#868778] uppercase font-bold">Total</span>
                                        <span class="text-[15px] font-bold text-[#1B1B18] dark:text-[#F3EFE7] leading-tight">{{ number_format($adKycTotal) }}</span>
                                        <span class="text-[9px] text-[#8A857A] dark:text-[#868778]">{{ $isFr ? 'demandes' : 'requests' }}</span>
                                    </div>
                                </div>
                                <ul class="flex-1 min-w-0 space-y-2.5">
                                    @foreach($adKyc as [$kyLabel, $kyColor, $kyCount, $kyPct])
                                    <li class="flex items-center gap-2 text-[11px] text-[#3B382F] dark:text-[#B4B5A6] whitespace-nowrap">
                        ...
                        <section class="bg-white dark:bg-[#12150F] border border-[#EFEBE2] dark:border-[#262B21] rounded-2xl p-5">
                            <div class="flex items-center justify-between gap-3">
                                <h2 class="text-[12px] font-bold tracking-[0.04em] text-[#1B1B18] dark:text-[#F3EFE7] uppercase leading-snug">{{ $isFr ? 'Entreprises par statut' : 'Businesses by status' }}</h2>
                                <a href="{{ route('admin.businesses') }}" class="shrink-0 text-[11.5px] font-semibold text-[#157A43] dark:text-[#339B56]">{{ $isFr ? 'Voir tout' : 'See all' }}</a>
                            </div>
                            <div class="mt-4 flex items-center gap-4">
                                <div class="relative w-[110px] h-[110px] shrink-0 rounded-full" style="background:{{ $adBizCss }}">
                                    <div class="absolute inset-[16px] rounded-full bg-white dark:bg-[#12150F] flex flex-col items-center justify-center text-center">
                                        <span class="text-[9px] text-[#8A857A] dark:text-[#868778] uppercase font-bold">Total</span>
                                        <span class="text-[15px] font-bold text-[#1B1B18] dark:text-[#F3EFE7] leading-tight">{{ number_format($adBizStatusTotal) }}</span>
                                        <span class="text-[9px] text-[#8A857A] dark:text-[#868778]">{{ $isFr ? 'entreprises' : 'businesses' }}</span>
                                    </div>
                                </div>
                                <ul class="flex-1 min-w-0 space-y-2.5">
                    ...
                    <section class="mt-4 bg-white dark:bg-[#12150F] border border-[#EFEBE2] dark:border-[#262B21] rounded-2xl p-5">
                        <h2 class="text-[12.5px] font-bold tracking-[0.04em] text-[#1B1B18] dark:text-[#F3EFE7] uppercase">{{ $isFr ? 'Activité par région' : 'Activity by region' }}</h2>
                        <div class="mt-2 overflow-x-auto">
                            <table class="w-full">
                                <thead>
                                    <tr class="text-left border-b border-[#F0EBE0] dark:border-[#262B21]">
                                        <th class="py-2 text-[11px] font-semibold text-[#8A857A] dark:text-[#868778]">{{ $isFr ? 'Région' : 'Region' }}</th>
                                        <th class="py-2 text-[11px] font-semibold text-[#8A857A] dark:text-[#868778]">{{ $isFr ? 'Entreprises' : 'Businesses' }}</th>
                                        <th class="py-2 text-[11px] font-semibold text-[#8A857A] dark:text-[#868778]">{{ $isFr ? 'Produits' : 'Products' }}</th>
                                        <th class="py-2 text-[11px] font-semibold text-[#8A857A] dark:text-[#868778]">{{ $isFr ? 'Visites' : 'Visits' }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @forelse($adRegionTable as $rr)
                                    <tr>
                                        <td class="py-2 text-[12px] text-[#1B1B18] dark:text-[#F3EFE7]">{{ $rr->name_fr }}</td>
                                        <td class="py-2 text-[12px] text-[#3B382F] dark:text-[#B4B5A6]">{{ number_format($rr->businesses_total) }}</td>
                                        <td class="py-2 text-[12px] text-[#3B382F] dark:text-[#B4B5A6]">{{ number_format($rr->products_total) }}</td>
                                        <td class="py-2 text-[12px] text-[#3B382F] dark:text-[#B4B5A6]">{{ number_format($rr->visits_total) }}</td>
                                    </tr>
                                    @empty
                                    <tr><td colspan="4" class="py-4 text-center text-[12px] text-[#8A857A] dark:text-[#868778]">{{ $isFr ? 'Aucune donnée régionale.' : 'No regional data.' }}</td></tr>
                                    @endforelse
                                </tbody>
                            </table>
                        </div>
                    ...
                    <p class="mt-5 text-center text-[11.5px] text-[#8A857A] dark:text-[#868778]">© 2025 {{ $isFr ? 'Artisan Hub 237. Tous droits réservés.' : 'Artisan Hub 237. All rights reserved.' }}</p>
                </div>

                <!-- Right rail -->
                <aside class="w-full 2xl:w-[330px] shrink-0 space-y-4">
                    <section class="bg-white dark:bg-[#12150F] border border-[#EFEBE2] dark:border-[#262B21] rounded-2xl p-4">
                        <div class="flex items-center justify-between gap-3">
                            <h2 class="text-[12.5px] font-bold tracking-[0.04em] text-[#1B1B18] dark:text-[#F3EFE7] uppercase">{{ $isFr ? 'Artisan à l\'honneur' : 'Featured artisan' }}</h2>
                            <a href="{{ route('admin.businesses') }}" class="shrink-0 text-[11px] font-semibold text-[#C97A16] dark:text-[#EDB33A]">{{ $isFr ? 'Voir tous' : 'See all' }} ↗</a>
                        </div>
                        @if($featuredBusiness)
                        <div class="mt-3 flex items-center gap-3.5">
                            ...
                            <div class="min-w-0">
                                <p class="text-[14px] font-bold text-[#1B1B18] dark:text-[#F3EFE7]">{{ $featuredBusiness->name_fr }}</p>
                                @if($featuredBusiness->industry_fr)<p class="mt-0.5 text-[11.5px] font-semibold text-[#C97A16] dark:text-[#EDB33A] underline underline-offset-2">{{ $featuredBusiness->industry_fr }}</p>@endif
                                @if($featuredBusiness->region_fr)<p class="mt-1 flex items-center gap-1.5 text-[11px] text-[#6F6B60] dark:text-[#868778]"><i data-lucide="map-pin" class="w-3 h-3"></i> {{ $featuredBusiness->region_fr }}</p>@endif
                                <a href="{{ route('businesses.index', ['lang' => $lang]) }}" class="mt-2 inline-flex items-center bg-[#0B3B20] dark:bg-[#0C3B1E] hover:bg-[#14652F] dark:hover:bg-[#2E9250] rounded-lg px-4 py-1.5 text-[11.5px] font-semibold text-white transition-colors">{{ $isFr ? 'Voir le profil' : 'View the profile' }}</a>
                            </div>
                        </div>
                        @else
                        <p class="mt-3 text-[12px] text-[#8A857A] dark:text-[#868778]">{{ $isFr ? 'Aucune entreprise mise en avant pour le moment.' : 'No featured business yet.' }}</p>
                        @endif
                    </section>

                    <section class="bg-white dark:bg-[#12150F] border border-[#EFEBE2] dark:border-[#262B21] rounded-2xl p-4">
                        <div class="flex items-center justify-between gap-3">
                            <h2 class="text-[12.5px] font-bold tracking-[0.04em] text-[#1B1B18] dark:text-[#F3EFE7] uppercase">{{ $isFr ? 'Activités récentes' : 'Recent activities' }}</h2>
                            <a href="{{ route('admin.audit-log') }}" class="shrink-0 text-[11px] font-semibold text-[#157A43] dark:text-[#339B56]">{{ $isFr ? 'Voir toutes' : 'See all' }} ↗</a>
                        </div>
                        <div class="mt-2 divide-y divide-[#F5F1E8] dark:divide-[#262B21]">
                            ...
                            <div class="flex items-start gap-3 py-2.5">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-[11.5px] font-bold text-[#1B1B18] dark:text-[#F3EFE7] leading-snug">{{ $avTitle }}</p>
                                    <p class="mt-0.5 text-[10.5px] text-[#6F6B60] dark:text-[#868778]">{{ $avSub }}</p>
                                </div>
                                <span class="shrink-0 text-[10px] text-[#8A857A] dark:text-[#868778] whitespace-nowrap pt-0.5">{{ $avWhen }}</span>
                            </div>
                            @empty
                            <p class="py-4 text-center text-[11.5px] text-[#8A857A] dark:text-[#868778]">{{ $isFr ? 'Aucune activité récente.' : 'No recent activity.' }}</p>
                            @endforelse
                        </div>
                    </section>
                    ...
                    <section class="bg-white dark:bg-[#12150F] border border-[#EFEBE2] dark:border-[#262B21] rounded-2xl p-4">
                        <div class="flex items-center justify-between gap-3">
                            <h2 class="text-[12.5px] font-bold tracking-[0.04em] text-[#1B1B18] dark:text-[#F3EFE7] uppercase">{{ $isFr ? 'Revenus par mois (FCFA)' : 'Revenue by month (FCFA)' }}</h2>
                            <a href="{{ route('admin.reports') }}" class="shrink-0 text-[11px] font-semibold text-[#157A43] dark:text-[#339B56]">{{ $isFr ? 'Voir le rapport' : 'Report' }}</a>
                        </div>
                        <div class="mt-3 flex items-stretch gap-2">
                            <div class="flex-1 flex items-end justify-between gap-2 h-[130px] border-b border-[#F0EBE0] dark:border-[#262B21] px-1">
                                @foreach($adRevenueView as [$rvMonth, $rvPct])
                                <div class="flex-1 flex items-end justify-center h-full">
                                    <div class="w-full max-w-[26px] bg-[#14652F] dark:bg-[#2E9250] rounded-t-[3px]" style="height:{{ $rvPct }}%"></div>
                                </div>
                                @endforeach
                            </div>
                        </div>
                        <div class="mt-1.5 flex items-center justify-between gap-2 px-1">
                            @foreach($adRevenueView as [$rvMonth, $rvPct])
                            <span class="flex-1 text-center text-[10px] text-[#8A857A] dark:text-[#868778]">{{ $rvMonth }}</span>
                            @endforeach
                        </div>
                    </section>

                    <div class="flex flex-wrap items-center justify-between gap-2 px-1 text-[11.5px] text-[#55524A] dark:text-[#B4B5A6]">
                        <a href="{{ route('support.index') }}" class="flex items-center gap-1.5 hover:text-[#14652F] dark:hover:text-[#339B56]"><i data-lucide="circle-help" class="w-3.5 h-3.5"></i> {{ $isFr ? 'Aide' : 'Help' }}</a>
                        <a href="{{ route('admin.support') }}" class="flex items-center gap-1.5 hover:text-[#14652F] dark:hover:text-[#339B56]"><i data-lucide="life-buoy" class="w-3.5 h-3.5"></i> {{ $isFr ? 'Centre d\'assistance' : 'Assistance centre' }}</a>
                        <a href="{{ route('contact', ['lang' => $lang]) }}" class="flex items-center gap-1.5 hover:text-[#14652F] dark:hover:text-[#339B56]"><i data-lucide="mail" class="w-3.5 h-3.5"></i> {{ $isFr ? 'Nous contacter' : 'Contact us' }}</a>
                    </div>
                </aside>
            </div>
@endsection
