...
<head>
    ...
    <title>{{ $isFr ? 'Data Export Centre — Administration' : 'Data Export Centre — Administration' }}</title>
    ...
    <style>
        ...
        @media (min-width: 1024px) { #ad-sidebar, #ad-sidebar.ad-open { display: flex; position: sticky; top: 0; height: 100vh; width: 290px; } }
