...
@php
    $isFr = $lang === 'fr';
    $adminActive = 'media';
    $pageTitle = $isFr ? 'Gestion des Médias & Documents' : 'Media & Documents Management';
    $pageBreadcrumb = [
        [$isFr ? 'Accueil' : 'Home', route('dashboard.admin', ['lang' => $lang])],
        [$isFr ? 'Médias & Documents' : 'Media & Documents', null],
    ];
...
@section('content')
            ...
            <section class="mt-4 grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-3">
                ...
                <a href="{{ route('admin.media', array_filter(['lang' => $lang, 'type' => $ck === 'all' ? null : $ck])) }}"
                   class="bg-white dark:bg-[#12150F] border {{ $mediaType === $ck || ($ck === 'all' && $mediaType === 'all') ? 'border-[#14652F] dark:border-[#2E9250]' : 'border-[#EFEBE2] dark:border-[#262B21] ' }} rounded-2xl p-4 flex items-start gap-3 hover:border-[#14652F] dark:hover:border-[#2E9250] transition-colors">
                ...
                <div class="ui-card flex items-start gap-3">
                    <span class="shrink-0 w-[42px] h-[42px] rounded-xl bg-[#E8F3EC] dark:bg-[#1A1E16] flex items-center justify-center">
            ...
            <div class="mt-4 flex flex-col xl:flex-row items-start gap-4">
                ...
                <div class="flex-1 min-w-0 w-full">
                    ...
                    <form method="GET" action="{{ route('admin.media') }}" class="ui-card flex flex-wrap items-center gap-2.5">
                        ...
                        <span class="ml-auto flex items-center gap-1.5">
                            <span class="w-[34px] h-[34px] rounded-lg border border-[#EAE5D8] dark:border-[#262B21] flex items-center justify-center text-[#8A857A] dark:text-[#868778]"><i data-lucide="layout-grid" class="w-[15px] h-[15px]"></i></span>
                            <span class="w-[34px] h-[34px] rounded-lg bg-[#0F4824] dark:bg-[#2E9250] flex items-center justify-center text-white dark:text-[#04150A]"><i data-lucide="list" class="w-[15px] h-[15px]"></i></span>
                        </span>
                    </form>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-3">
                        ...
                        <div class="ui-card ui-card--flush">
                            <div class="relative h-[110px] bg-[#F3EFE5] dark:bg-[#1A1E16]">
                                ...
                                <div class="w-full h-full flex items-center justify-center">
                                    <span class="w-14 h-14 rounded-full bg-[#E7E2D5] dark:bg-[#1A1E16] flex items-center justify-center"><i data-lucide="audio-lines" class="w-6 h-6 text-[#3B382F] dark:text-[#B4B5A6]"></i></span>
                                </div>
                                @else
                                <div class="w-full h-full flex items-center justify-center">
                ...
                <aside class="w-full xl:w-[320px] shrink-0 space-y-4">
                    ...
                    {{-- Conseils --}}
                    <section class="bg-[#FBF6E8] dark:bg-[#1A1E16] border border-[#F0E6C8] dark:border-[#4A3A12] rounded-2xl p-4">
