...
<div class="max-w-[1400px]">
    ...
    <div class="ui-card ui-card--flush">
            ...
            <table class="ui-table">
                ...
                <tbody>
                    ...
                    <tr class="border-t border-[#EFEBE2] hover:bg-[#FAFAF8]">
                        <td><span class="text-[12px] font-semibold text-[#1B1B18] font-mono">{{ $r->certificate_no }}</span></td>
                        <td class="font-semibold text-[#1B1B18]">{{ $r->name_fr }}</td>
                        <td>{{ $r->trade ?? '—' }}</td>
        ...
        <div class="px-5 py-3.5 border-t border-[#EFEBE2]">
