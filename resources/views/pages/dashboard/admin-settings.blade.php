...
$logoUrl    = filled($logoVal)    ? asset('storage/' . $logoVal)    : brand_asset('mark');
$faviconUrl = filled($faviconVal) ? asset('storage/' . $faviconVal) : brand_asset('mark');
...
$socialRows = [
    'social_facebook'  => ['Facebook',    '#1877F2', 'https://facebook.com/artisanhub237',
        '<path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>'],
    'social_instagram' => ['Instagram',   '#E4405F', 'https://instagram.com/artisanhub237',
    ...
    'social_twitter'   => ['Twitter (X)', '#0F1419', 'https://twitter.com/artisanhub237',
        '<path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z"/>'],
    'social_youtube'   => ['YouTube',     '#FF0000', 'https://youtube.com/@artisanhub237',
        '<path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>'],
    'social_linkedin'  => ['LinkedIn',    '#0A66C2', 'https://linkedin.com/company/artisanhub237',
    ...
    <form method="POST" action="{{ route('admin.settings.general') }}" class="{{ $cardCls }} space-y-4">
        ...
        <div>
            ...
            <input type="email" name="settings[contact_email]" required class="{{ $inputCls }}"
                   value="{{ $p('contact_email', config('legal.company.email')) }}">
        </div>
        <div>
