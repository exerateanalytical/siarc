                ...
                <div class="space-y-5">
                    ...
                    <section class="ui-card">
                        ...
                        <div class="mt-4 border border-[#EFEBE2] rounded-xl overflow-hidden">
                            <div class="bg-gradient-to-r from-[#0E3D22] to-[#12522C] px-6 py-4 flex items-center gap-3"><img src="{{ brand_asset('mark') }}" alt="" class="w-10 h-10 object-contain"><div><p class="text-[11px] font-bold text-white uppercase leading-tight">Artisan Hub 237<br>de l'Artisanat du Cameroun</p></div></div>
