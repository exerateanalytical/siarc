                            ...
                            <tbody class="divide-y divide-[#F5F1E8]">
                                ...
                                <tr>
                                    ...
                                    <td class="px-2 pr-4 py-3 text-right whitespace-nowrap">
                                        <a href="{{ route('news.index') }}?lang={{ $lang }}" title="{{ $isFr ? 'Voir' : 'View' }}" class="inline-flex w-[28px] h-[28px] rounded-md border border-[#E9E4D8] items-center justify-center text-[#55524A] hover:text-[#157A43] hover:border-[#157A43] transition-colors align-middle"><i data-lucide="eye" class="w-[14px] h-[14px]"></i></a>
                                        <a href="{{ route('news.index') }}?lang={{ $lang }}" title="{{ $isFr ? 'Modifier' : 'Edit' }}" class="ml-1 inline-flex w-[28px] h-[28px] rounded-md border border-[#E9E4D8] items-center justify-center text-[#55524A] hover:text-[#C97A16] hover:border-[#C97A16] transition-colors align-middle"><i data-lucide="pencil" class="w-[14px] h-[14px]"></i></a>
                                        <button type="button" title="Plus" class="ml-1 inline-flex w-[28px] h-[28px] rounded-md border border-[#E9E4D8] items-center justify-center text-[#55524A] hover:text-[#1B1B18] transition-colors align-middle"><i data-lucide="more-vertical" class="w-[14px] h-[14px]"></i></button>
                                    </td>
                                </tr>
                                @empty
