...
<head>
    ...
    <title>{{ $isFr ? 'Gestion des Commandes — Administration' : 'Order Management — Administration' }}</title>
    ...
    <div class="flex-1 min-w-0">
        ...
        <main class="px-5 lg:px-7 pb-8">
            <div class="flex flex-wrap items-center justify-between gap-3">
                <div>
                    <h1 class="text-[20px] font-bold text-[#1B1B18]">{{ $isFr ? 'Gestion des Commandes' : 'Order Management' }}</h1>
                    <p class="mt-0.5 text-[12.5px] text-[#6F6B60]">
                        ...
                        <span>{{ $isFr ? 'Commandes' : 'Orders' }}</span>
                    </p>
                </div>
