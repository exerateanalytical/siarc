        ...
        <div class="flex items-start justify-between gap-6 flex-wrap">
            <div>
                ...
                <nav class="flex items-center gap-2 text-[13px] text-[#8A857A] mt-1.5">
                    <a href="{{ $h('siarc.speakers') }}" class="hover:text-siarc-green transition-colors">{{ $isFr ? 'Intervenants' : 'Speakers' }}</a>
            ...
            <div class="flex items-center gap-2.5">
                <a href="{{ $h('siarc.speakers') }}" class="inline-flex items-center gap-2 bg-white border border-[#E4E1D8] text-[#3A362E] text-[13px] font-medium px-4 py-2.5 rounded-xl hover:bg-[#FAF8F3] transition-colors">
                    <i data-lucide="arrow-left" class="w-4 h-4"></i>{{ $isFr ? 'Retour à la liste' : 'Back to list' }}
                </a>
                <button type="button" class="inline-flex items-center gap-2 bg-white border border-[#E4E1D8] text-[#3A362E] text-[13px] font-medium px-4 py-2.5 rounded-xl hover:bg-[#FAF8F3] transition-colors">
                    <i data-lucide="download" class="w-4 h-4"></i>{{ $isFr ? 'Télécharger le badge' : 'Download badge' }}
                </button>
                <button type="button" class="inline-flex items-center gap-2 bg-[#0B3A1E] text-white text-[13px] font-semibold px-4 py-2.5 rounded-xl hover:brightness-110 transition-all">
                    <i data-lucide="square-pen" class="w-4 h-4"></i>{{ $isFr ? 'Modifier l\'intervenant' : 'Edit speaker' }}
                </button>
                <button type="button" class="inline-flex items-center justify-center w-10 h-10 bg-white border border-[#E4E1D8] text-[#3A362E] rounded-xl hover:bg-[#FAF8F3] transition-colors">
...
<section class="bg-[#F5F3EE]">
    <div class="max-w-[1360px] mx-auto px-6 sm:px-10 py-6 grid lg:grid-cols-[1fr_352px] gap-6 items-start">
        ...
        <div class="space-y-6 min-w-0">
            ...
            {{-- ── Tabs ── --}}
            <div class="border-b border-[#ECEAE3] -mt-2">
                <div class="flex items-center gap-8 text-[14px] overflow-x-auto">
                    <button type="button" class="relative pb-3 font-semibold text-siarc-green whitespace-nowrap">
                        {{ $isFr ? 'Aperçu' : 'Overview' }}
                        <span class="absolute left-0 right-0 -bottom-px h-[2.5px] bg-siarc-green rounded-full"></span>
                    </button>
                    <button type="button" class="pb-3 text-[#6C685E] hover:text-[#1A1712] transition-colors whitespace-nowrap">Sessions (2)</button>
                    <button type="button" class="pb-3 text-[#6C685E] hover:text-[#1A1712] transition-colors whitespace-nowrap">Biographie</button>
                    <button type="button" class="pb-3 text-[#6C685E] hover:text-[#1A1712] transition-colors whitespace-nowrap">Médias</button>
                    <button type="button" class="pb-3 text-[#6C685E] hover:text-[#1A1712] transition-colors whitespace-nowrap">Documents</button>
                    <button type="button" class="pb-3 text-[#6C685E] hover:text-[#1A1712] transition-colors whitespace-nowrap">{{ $isFr ? 'Informations pratiques' : 'Practical information' }}</button>
                    <button type="button" class="pb-3 text-[#6C685E] hover:text-[#1A1712] transition-colors whitespace-nowrap">{{ $isFr ? 'Historique' : 'History' }}</button>
                </div>
            </div>

            {{-- ── À propos + Sessions assignées ── --}}
            <div class="grid lg:grid-cols-2 gap-6">
                ...
                <div class="siarc-card siarc-shadow p-6 sm:p-7">
                    ...
                    <div class="flex items-center gap-2.5">
                        <a href="{{ $h('siarc.speakers') }}" aria-label="LinkedIn" class="w-9 h-9 rounded-lg flex items-center justify-center bg-[#0A66C2] text-white hover:brightness-110 transition">
                        ...
                        <a href="{{ $h('siarc.speakers') }}" aria-label="X" class="w-9 h-9 rounded-lg flex items-center justify-center bg-[#111111] text-white hover:brightness-125 transition">
                        ...
                        <a href="{{ $h('siarc.speakers') }}" aria-label="Site web" class="w-9 h-9 rounded-lg flex items-center justify-center bg-white border border-[#E4E1D8] text-[#3A362E] hover:bg-[#FAF8F3] transition">
                            <i data-lucide="globe" class="w-4.5 h-4.5"></i>
                        </a>
                        <a href="{{ $h('siarc.speakers') }}" aria-label="YouTube" class="w-9 h-9 rounded-lg flex items-center justify-center bg-[#FF0000] text-white hover:brightness-110 transition">
                ...
                <div class="siarc-card siarc-shadow p-6 sm:p-7">
                        ...
                        <div class="min-w-0 flex-1">
                            <div class="flex items-start justify-between gap-3">
                                <div class="min-w-0">
                                    ...
                                    <p class="text-[14px] font-semibold text-[#1A1712] leading-snug mt-1">L'artisanat africain à l'ère de l'innovation et du numérique</p>
                                </div>
                        ...
                        <div class="min-w-0 flex-1">
                            <div class="flex items-start justify-between gap-3">
                                <div class="min-w-0">
                                    ...
                                    <p class="text-[14px] font-semibold text-[#1A1712] leading-snug mt-1">Financement et accompagnement des artisans innovants</p>
                                </div>
                    ...
                    <a href="{{ $h('siarc.program') }}" class="mt-5 flex items-center justify-center gap-2 w-full bg-white border border-[#E4E1D8] text-[#3A362E] text-[13px] font-semibold py-3 rounded-xl hover:bg-[#FAF8F3] transition-colors">
            ...
            <div class="siarc-card siarc-shadow p-6 sm:p-7">
                <div class="flex items-start justify-between gap-4">
                    ...
                    <button type="button" class="inline-flex items-center justify-center w-10 h-10 bg-white border border-[#E4E1D8] text-[#3A362E] rounded-xl hover:bg-[#FAF8F3] transition-colors shrink-0">
        ...
        <aside class="space-y-6">
            ...
            <div class="siarc-card siarc-shadow p-6">
                ...
                <div class="space-y-3.5 text-[13.5px] text-[#3A362E]">
                    ...
                    <a href="{{ $h('siarc.home') }}" class="flex items-center gap-3 hover:text-siarc-green transition-colors"><i data-lucide="globe" class="w-4 h-4 text-[#8A857A] shrink-0"></i>www.techcraftafrica.com</a>
                    <span class="flex items-center gap-3"><i data-lucide="linkedin" class="w-4 h-4 text-[#8A857A] shrink-0"></i>linkedin.com/in/alainmbarga</span>
                </div>
            </div>
            ...
            <div class="siarc-card siarc-shadow p-6">
                ...
                <div class="flex items-center justify-between gap-3">
                    ...
                    <a href="{{ $h('siarc.exhibitors') }}" class="inline-flex items-center bg-white border border-[#7C4DD1]/40 text-[#7C4DD1] text-[12px] font-semibold px-3 py-1.5 rounded-lg hover:bg-[#F7F3FE] transition-colors">{{ $isFr ? 'Voir l\'entreprise' : 'View company' }}</a>
                </div>
            </div>
            ...
            <div class="siarc-card siarc-shadow p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <button type="button" class="text-[#8A857A] hover:text-siarc-green transition-colors shrink-0"><i data-lucide="download" class="w-4.5 h-4.5"></i></button>
                    </div>
                    @endforeach
                </div>
                <a href="{{ $h('siarc.speakers') }}" class="mt-5 flex items-center justify-end gap-2 text-[13px] font-semibold text-siarc-green hover:gap-3 transition-all">
            ...
            <div class="siarc-card siarc-shadow p-6">
                ...
                <button type="button" class="mt-5 flex items-center justify-center gap-2 w-full bg-white border border-[#E4E1D8] text-[#3A362E] text-[13px] font-semibold py-3 rounded-xl hover:bg-[#FAF8F3] transition-colors">
