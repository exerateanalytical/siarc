        ...
        <div class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div class="flex flex-col lg:flex-row lg:items-end gap-3">
                ...
                <div class="relative flex-1 min-w-[220px] self-stretch lg:self-end">
                    ...
                    <input type="text" aria-label="Rechercher un pavillon"
                ...
                {{-- select dropdowns --}}
                @foreach([
                    ['label'=>'Type de pavillon','first'=>'Tous les types','info'=>true],
                    ['label'=>'Région / Pays','first'=>'Toutes les régions','info'=>true],
                    ['label'=>'Thématique','first'=>'Toutes les thématiques','info'=>false],
                ] as $sel)
                <div>
                    ...
                    <div class="relative">
                        <select aria-label="{{ $sel['label'] }}" class="appearance-none text-[13px] font-medium text-[#2A271F] pl-3.5 pr-9 py-2.5 rounded-lg border border-[#E4E0D6] bg-white focus:outline-none focus:ring-2 focus:ring-siarc-green/20 cursor-pointer min-w-[170px]">
                ...
                @endforeach
                <button type="button" class="inline-flex items-center gap-2 text-[13px] font-semibold text-[#2A271F] px-4 py-2.5 rounded-lg border border-[#E4E0D6] bg-white hover:bg-[#F5F3EE] transition-colors shrink-0 self-end">
            ...
            <div class="min-w-0">
                ...
                <div class="relative mb-10">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        @foreach($featured as $p)
                            @php $bt = $badgeTone($p['badge']); $href = $exUrl; @endphp
                    ...
                    <button type="button" aria-label="Pavillon suivant" class="hidden lg:flex absolute -right-3 top-[72px] w-9 h-9 rounded-full bg-white siarc-shadow items-center justify-center text-[#2A271F] hover:bg-[#F5F3EE] transition-colors z-10">
                ...
                <div class="flex items-center justify-between gap-4 mb-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="relative">
                            <select aria-label="Trier par" class="appearance-none text-[12.5px] font-medium text-[#2A271F] pl-3 pr-8 py-1.5 rounded-lg border border-[#E4E0D6] bg-white focus:outline-none focus:ring-2 focus:ring-siarc-green/20 cursor-pointer">
                                <option>A - Z</option>
                            </select>
                        ...
                        <div class="flex items-center gap-1.5">
                            <button type="button" aria-label="Vue grille" class="w-8 h-8 rounded-lg flex items-center justify-center text-white bg-siarc-green"><i data-lucide="layout-grid" class="w-4 h-4"></i></button>
                            <button type="button" aria-label="Vue liste" class="w-8 h-8 rounded-lg flex items-center justify-center text-[#8A857A] border border-[#E4E0D6] bg-white hover:bg-[#F5F3EE]"><i data-lucide="clipboard-list" class="w-4 h-4"></i></button>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    @foreach($allPav as $p)
                        @php $bt = $badgeTone($p['badge']); @endphp
                        <div class="siarc-card siarc-shadow siarc-lift overflow-hidden flex flex-col group">
                ...
                <div class="flex justify-center mt-8">
                    <button type="button" class="inline-flex items-center gap-2 text-[13px] font-semibold text-[#2A271F] px-6 py-2.5 rounded-lg border border-[#E4E0D6] bg-white hover:bg-[#F5F3EE] transition-colors">
                ...
                <div class="siarc-card siarc-shadow p-5">
                    ...
                    <div class="relative rounded-xl overflow-hidden border border-[#EEECE5] bg-[#F7F5F0] p-5"
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            ...
                            <button type="button" aria-label="Voir le pavillon" class="relative aspect-square rounded-lg flex items-center justify-center transition-transform hover:scale-105"
