...
<section class="bg-cream dark:bg-[#0A0C09]">
    <div class="max-w-[1280px] mx-auto px-5 lg:px-8 pb-16">
        <div class="grid grid-cols-1 lg:grid-cols-[0.8fr_1fr] gap-5 items-stretch">
            <!-- Form card -->
            <div class="bg-[#FCF9F5] dark:bg-[#12150F] border border-[#ECE7DF] dark:border-[#262B21] rounded-xl p-6 sm:p-9">
                <h2 class="font-serif text-[26px] sm:text-[30px] text-[#20211D] dark:text-[#F3EFE7] font-medium">{{ $isFr ? 'Envoyez-nous un message' : 'Send us a message' }}</h2>
            ...
            <!-- Location card -->
            <div class="relative rounded-xl overflow-hidden border border-[#ECE7DF] dark:border-[#262B21] min-h-[320px] bg-[#F6F1EB] dark:bg-[#0A0C09] flex flex-col items-center justify-center text-center px-6 py-10"
...
<!-- How can we help -->
<section class="relative bg-[#F6F1EB] dark:bg-[#0A0C09] overflow-hidden">
    ...
    <div class="relative max-w-[1280px] mx-auto px-5 lg:px-8 py-12">
        <h2 class="font-serif text-[27px] sm:text-[31px] text-[#20211D] dark:text-[#F3EFE7] font-medium text-center">{{ $isFr ? 'Comment pouvons-nous vous aider ?' : 'How can we help you?' }}</h2>
