{{-- Gallery replica footer: dark green with kente side borders + Cameroon map + mobile bottom nav.
...
<footer class="relative bg-[#0B2C1E] overflow-hidden">
    <img src="{{ asset('images/landing/cat-footer-kente-left.png') }}" alt="" class="absolute inset-y-0 left-0 w-[64px] h-full object-cover hidden md:block pointer-events-none select-none" aria-hidden="true">
    <img src="{{ asset('images/landing/cat-footer-kente-right.png') }}" alt="" class="absolute inset-y-0 right-0 w-[64px] h-full object-cover hidden md:block pointer-events-none select-none" aria-hidden="true">

    <div class="relative max-w-[1280px] mx-auto px-5 lg:px-8 pt-10 pb-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.35fr_0.7fr_0.95fr_0.85fr_1.15fr_auto] gap-7">
            <!-- Brand -->
            <div>
                <div class="flex items-center gap-3">
                    <img src="{{ brand_asset('mark') }}" alt="" class="w-10 h-11 object-contain">
                ...
                <div class="mt-5 flex items-center gap-2">
                    @foreach(array_intersect_key($gfSocialIcons, $socialProfileUrls) as $socialName => $socialPath)
                    <a href="{{ $socialProfileUrls[$socialName] }}" target="_blank" rel="noopener" aria-label="{{ $socialName }}" class="w-8 h-8 rounded-full border border-white/25 flex items-center justify-center text-white hover:bg-white/10 transition-colors">
            ...
            <div class="hidden lg:flex items-center">
                <img src="{{ asset('images/landing/cat-footer-map.png') }}" alt="" class="w-[118px]" aria-hidden="true">
            </div>
        </div>
