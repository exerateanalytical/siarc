...
@php
    ...
    $adGroups = [
        ...
        [$isFr ? 'Gestion du contenu' : 'Content management', [
            ['artisans',    'users',         'Artisans',                                        route('admin.artisans'), null],
            ...
            ['collections', 'layers',        $isFr ? 'Collections Héritage' : 'Heritage Collections', route('admin.collections'), null],
            ...
            ['media',       'image',         $isFr ? 'Médias & Documents' : 'Media & Documents', route('admin.media'), null],
            ['events',      'calendar-days', $isFr ? 'Événements & Festivals' : 'Events & Festivals', route('admin.events'), null],
            ['news',        'megaphone',     $isFr ? 'Actualités & Annonces' : 'News & Announcements', route('admin.news'), null],
        ]],
        [$isFr ? 'Gestion des utilisateurs' : 'User management', [
            ...
            ['roles',         'key-round',    $isFr ? 'Rôles & Permissions' : 'Roles & Permissions', route('admin.roles'), null],
        ]],
        ...
        [$isFr ? 'Analyses & Rapports' : 'Analytics & Reports', [
            ['analytics', 'chart-pie',    $isFr ? 'Tableaux de Bord' : 'Dashboards',            route('admin.analytics'), null],
            ['reports',   'chart-column', $isFr ? 'Rapports Avancés' : 'Advanced Reports',      route('admin.reports'), null],
            ['exports',   'download',     $isFr ? 'Exports de Données' : 'Data Exports',        route('admin.reports') . '#exports', null],
        ]],
        ['SIARC 2026', [
