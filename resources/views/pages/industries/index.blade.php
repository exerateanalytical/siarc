...
<div class="max-w-6xl mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
        ...
        <a href="{{ route('businesses.index', ['lang' => $lang, 'industry' => $industry->slug]) }}"
            class="group bg-white border border-gray-200 rounded-xl p-4 sm:p-5 hover:border-forest-300 hover:shadow-md transition-all">
            <div class="flex items-center gap-3 mb-3">
                <div class="w-10 h-10 bg-forest-50 rounded-xl flex items-center justify-center group-hover:bg-forest-100 transition-colors shrink-0">
                    <i data-lucide="{{ $industry->icon ?? 'box' }}" class="w-5 h-5 text-forest-600"></i>
                </div>
                <div class="min-w-0">
                    <h2 class="font-semibold text-gray-900 text-sm line-clamp-1 group-hover:text-forest-600 transition-colors">
            ...
            @endif
            <div class="flex items-center text-xs text-forest-600 font-medium gap-1 group-hover:gap-2 transition-all">
