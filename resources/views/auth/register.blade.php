        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <label class="cursor-pointer">
                            ...
                            <div class="peer-checked:border-brand-500 peer-checked:bg-brand-50 border-2 border-gray-200 rounded-xl p-3 text-center transition-all hover:border-gray-300">
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input name="name" type="text" value="{{ old('name') }}"
                            ...
                            class="w-full pl-10 pr-4 py-2.5 border {{ $errors->has('name') ? 'border-red-400' : 'border-gray-300' }} rounded-lg text-sm focus:outline-none focus:border-brand-400 focus:ring-1 focus:ring-brand-400 transition"
                            required autofocus>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input name="email" type="email" value="{{ old('email') }}"
                            ...
                            class="w-full pl-10 pr-4 py-2.5 border {{ $errors->has('email') ? 'border-red-400' : 'border-gray-300' }} rounded-lg text-sm focus:outline-none focus:border-brand-400 focus:ring-1 focus:ring-brand-400 transition"
                            required>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input name="phone" type="tel" value="{{ old('phone') }}"
                            ...
                            class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:border-brand-400 focus:ring-1 focus:ring-brand-400 transition">
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input name="password" type="password"
                            ...
                            class="w-full pl-10 pr-4 py-2.5 border {{ $errors->has('password') ? 'border-red-400' : 'border-gray-300' }} rounded-lg text-sm focus:outline-none focus:border-brand-400 focus:ring-1 focus:ring-brand-400 transition"
                            required>
                    </div>
                </div>
            ...
            <div class="mt-6 pt-5 border-t border-gray-100 text-center">
                <p class="text-sm text-gray-500">
                    ...
                    <a href="/login?lang={{ $lang }}" class="text-brand-500 font-semibold hover:text-brand-600 ml-1">
