...
<div class="max-w-2xl mx-auto px-4 py-8">
    <h1 class="text-xl font-bold text-gray-900 mb-1">{{ $lang === 'fr' ? 'Conditions d\'utilisation' : 'Terms of Service' }}</h1>
    ...
    <div class="space-y-6 text-sm text-gray-600 leading-relaxed">
        <section>
            <h2 class="text-sm font-semibold text-gray-900 mb-1.5">1. {{ $lang === 'fr' ? 'Acceptation' : 'Acceptance' }}</h2>
            <p>{{ $lang === 'fr'
        ...
        <section>
            <h2 class="text-sm font-semibold text-gray-900 mb-1.5">2. {{ $lang === 'fr' ? 'Description de la plateforme' : 'Platform description' }}</h2>
            <p>{{ $lang === 'fr'
        ...
        <section>
            <h2 class="text-sm font-semibold text-gray-900 mb-1.5">3. {{ $lang === 'fr' ? 'Comptes et contenu' : 'Accounts and content' }}</h2>
            <p>{{ $lang === 'fr'
        ...
        <section>
            <h2 class="text-sm font-semibold text-gray-900 mb-1.5">4. {{ $lang === 'fr' ? 'Utilisations interdites' : 'Prohibited uses' }}</h2>
        ...
        <section>
            <h2 class="text-sm font-semibold text-gray-900 mb-1.5">5. {{ $lang === 'fr' ? 'Propriété intellectuelle' : 'Intellectual property' }}</h2>
            <p>{{ $lang === 'fr'
        ...
        <section>
            <h2 class="text-sm font-semibold text-gray-900 mb-1.5">6. {{ $lang === 'fr' ? 'Limitation de responsabilité' : 'Limitation of liability' }}</h2>
            <p>{{ $lang === 'fr'
        ...
        <section>
            <h2 class="text-sm font-semibold text-gray-900 mb-1.5">7. {{ $lang === 'fr' ? 'Droit applicable' : 'Governing law' }}</h2>
